...
go
ALTER PROCEDURE UserAccount_Register
    (@userName VARCHAR(30),
...
go
ALTER PROC UserAccount_GetPassword (@userName VARCHAR(30))
AS IF EXISTS (SELECT * FROM UserAccount WHERE userName = @userName) 
	BEGIN
